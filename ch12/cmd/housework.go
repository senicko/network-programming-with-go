...
import (
	...
	// "github.com/senicko/network-programming-with-go/ch12/housework"
	// storage "github.com/senicko/network-programming-with-go/ch12/json"
	// storage "github.com/senicko/network-programming-with-go/ch12/gob"
	// "github.com/senicko/network-programming-with-go/ch12/housework"
	housework "github.com/senicko/network-programming-with-go/ch12/housework/v1"
	storage "github.com/senicko/network-programming-with-go/ch12/protobuf"
)
...
func load() ([]*housework.Chore, error) {
	if _, err := os.Stat(dataFile); errors.Is(err, fs.ErrNotExist) {
